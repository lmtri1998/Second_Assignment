...
def test_flatten2() -> None:
    board, flatten_expected = construct_board2()
...
def test_flatten3() -> None:
    board, flatten_expected = construct_board3()
...
def test_rotate_big():
    ...
    temp0 = ans_board.children[0]
    temp2 = ans_board.children[2]
    ans_board.children[0] = ans_board.children[1]
    ans_board.children[2] = ans_board.children[3]
    ans_board.children[1] = temp2
    ans_board.children[3] = temp0
...
def test_rotate_twice():
    board, _ = construct_board()
    board1, _ = construct_board()
    board.rotate(1)
    board.rotate(3)

    assert equal_boards(board, board1)
...
def test_players():
    """
    Put 3 random players and 3 smart players against each other and ensure
    the game ends
    """
    import random
    random.seed(1001)
    game = Game(4, 0, 3, [1, 3, 5])
    game.run_game(3)
...
def construct_board2() -> Tuple[Block, List[List[Tuple[int, int, int]]]]:
    """Return a fixed board and its flattened representation.
    """
    rootblock = Block(0, children=[
    ...
    flattened_block = [
        ...
        [COLOUR_LIST[0], COLOUR_LIST[0], COLOUR_LIST[2], COLOUR_LIST[1]],
        [COLOUR_LIST[0], COLOUR_LIST[0], COLOUR_LIST[0], COLOUR_LIST[2]]
    ]

    return rootblock, flattened_block


def construct_board3() -> Tuple[Block, List[List[Tuple[int, int, int]]]]:
    """Return a fixed board and its flattened representation.
    """
    rootblock = Block(0, children=[
        Block(1, children=[
    ...
    flattened_block = [
        [COLOUR_LIST[1], COLOUR_LIST[1], COLOUR_LIST[1], COLOUR_LIST[1]],
        [COLOUR_LIST[0], COLOUR_LIST[2], COLOUR_LIST[2], COLOUR_LIST[0]],
        [COLOUR_LIST[1], COLOUR_LIST[2], COLOUR_LIST[2], COLOUR_LIST[1]],
        [COLOUR_LIST[2], COLOUR_LIST[0], COLOUR_LIST[0], COLOUR_LIST[2]]
    ]
